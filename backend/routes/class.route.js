...
import { assignClass, createClass, deleteClass, fetchClasses, fetchClassesbyid } from "../controllers/class.controller.js";
...
router.post("/assign/:id",authMiddleware,roleMiddleware(["admin"]),assignClass)
