...
import { createStudent, deleteStudent, fetchSubjects, getStudent } from "../controllers/student.contoller.js";
...
router.get("/fetchSubjects",authMiddleware,roleMiddleware(["student"]),fetchSubjects);
